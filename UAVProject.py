...
'''
 ...
 UAV will have an initial velocity of 5m/s in X direction & 5 m/s
 in Y direction after 4 seconds UAV will have a constant velocity
 ...
 Coordiates of Target Location Latitude--58d 38m 38sN, Longitude--003d 04m 12s W
 '''
...
cd=0.47 # assuming an air drag coeffucient of 0.47
fd=cd*A/((vx-u)*(vx-u)*2)
